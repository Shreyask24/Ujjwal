...
import EA from "../assets/Energy-Audit.png"
...
const SafetyServices = () => {
    ...
    const [openSubDetail, setOpenSubDetail] = useState(null);
    ...
    const handleSubDetailToggle = (subDetailId) => {
        setOpenSubDetail((prev) => (prev === subDetailId ? null : subDetailId));
    };
    ...
    return (
        <section>
            ...
            <div className='safety-services' id='risk-assessment'>
                ...
                <div className='safety-services-ra'>
                    <details open className='details-1'>
                        ...
                        <details className='subdetails' open={openSubDetail === "1.1"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("1.1");
                            }}>
                            <summary><b><span className='subdetails-circle'> 1.1.</span> Quantitative Risk Assessment (QRA) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "1.2"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("1.2");
                            }}>
                            <summary><b> <span className='subdetails-circle'> 1.2.</span> Consequence Analysis</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "1.3"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("1.3");
                            }}>
                            <summary><b><span className='subdetails-circle'> 1.3.</span> Dispersion Modelling Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "1.4"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("1.4");
                            }}>
                            <summary><b><span className='subdetails-circle'> 1.4.</span> Fire and Explosion Risk Analysis (FERA) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "1.5"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("1.5");
                            }}>
                            <summary><b><span className='subdetails-circle'> 1.5.</span> Flare Radiation Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "1.6"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("1.6");
                            }}>
                            <summary><b><span className='subdetails-circle'> 1.6.</span> 3D F & G Mapping</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "1.7"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("1.7");
                            }}>
                            <summary><b><span className='subdetails-circle'> 1.7.</span> Escape, Evacuation & Rescue Analysis (EERA) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "1.8"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("1.8");
                            }}>
                            <summary><b><span className='subdetails-circle'> 1.8.</span> As Low As Reasonably Practicable (ALARP) Study</b></summary>
                            <p>
            ...
            <div className='safety-services-alt' id='workshop-facilitation'>
                ...
                <div className='safety-services-ra'>
                    <details open className='details-1'>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.1"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.1");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.1.</span> Process Hazard Analysis (PHA)</b></summary>
                            <p>
                                Our QRA studies are tailored to industries in key regions such as Gujarat’s petrochemical sector, Maharashtra’s chemical industries, and Tamil Nadu’s manufacturing hubs. We assess potential hazards, quantifying risks to people, the environment, and assets in facilities like high-pressure pipelines, storage sites, and production units to ensure safety compliance with Indian regulations and global safety standards.
                            </p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.2"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.2");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.1.</span> Hazard Identification (HAZID) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.3"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.3");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.3.</span> Hazard & Operability (HAZOP) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.4"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.4");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.4.</span> Safety & Operability (SAFOP/eHAZOP) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.5"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.5");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.5.</span> Hazard Identification & Risk Assessment (HIRA) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.6"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.6");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.6.</span> Environmental Impact Identification (ENVID) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.7"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.7");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.7.</span> Health Risk Assessment (HRA) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.8"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.8");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.8.</span> Project HSE Review (PHSER) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.9"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.9");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.9.</span> Simultaneous Operations (SIMOPS) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "2.10"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("2.10");
                            }}>
                            <summary><b><span className='subdetails-circle-alt'> 2.10.</span> Bow-Tie Analysis Study</b></summary>
                            <p>
            ...
            <div className='safety-services' id='functional-safety-services'>
                ...
                <div className='safety-services-ra'>
                    <details open className='details-1'>
                        ...
                        <details className='subdetails' open={openSubDetail === "3.1"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("3.1");
                            }}>
                            <summary><b><span className='subdetails-circle'> 3.1.</span> Safety Integrity Level (SIL)</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "3.2"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("3.2");
                            }}>
                            <summary><b><span className='subdetails-circle'> 3.2.</span> Failure Modes & Effects Analysis (FMEA) and Failure Modes, Effect & Criticality Analysis (FMECA)</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "3.3"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("3.3");
                            }}>
                            <summary><b><span className='subdetails-circle'> 3.3.</span> Reliability Availability Maintainability (RAM) Study</b></summary>
                            <p>
                        ...
                        <details className='subdetails' open={openSubDetail === "3.4"}
                            onClick={(e) => {
                                e.preventDefault();
                                handleSubDetailToggle("3.4");
                            }}>
                            <summary><b><span className='subdetails-circle'> 3.4.</span> Reliability-Centered Maintenance (RCM)</b></summary>
                            <p>
            ...
            <div className='safety-services-alt' id='other-safety-desktop-studies'>
                ...
                <div className='safety-services-ra'>
                    <details open className='details-1'>
                        <summary className='summary1'><b><h1> <span className='symbols'>6.</span> Safety Audit   </h1></b> </summary>
                        <p><b> We offer expert safety audit services</b> to enhance workplace safety and compliance. We identify hazards, assess risks, and provide actionable solutions tailored to your industry.</p>
                        ...
                        <p>
                            <b>Benefits:</b>
                            <li><b>Safer workplaces</b> </li>
                            <li><b>Regulatory compliance</b> </li>
                            <li><b>Improved productivity</b> </li>
                            <li><b>Cost savings</b></li>
                        </p>

                        <p>
                            <b>Industries Served: </b>
                            Manufacturing, Construction, Healthcare, Logistics, and more.
                        </p>
                    </details>
                </div>
            ...
            <div className='safety-services' id='other-safety-desktop-studies'>
                ...
                <div className='safety-services-ra'>
                    <details open className='details-1'>
                        <summary className='summary1'><b><h1> <span className='symbols'>7.</span> Energy Audit   </h1></b> </summary>
                        <p>UEES specializes in energy audit services to help businesses improve energy efficiency, lower operational costs, and meet sustainability goals. Our experts analyze your energy consumption and provide actionable insights tailored to your needs.</p>

                        <p>
                            <b>Key Features:</b>
                            <li><b>Comprehensive Analysis:</b> Evaluate energy usage across all operations.</li>
                            <li><b>Customized Recommendations: </b>Solutions tailored to your business. As per ASHRAE 211-2018, ISO 50001/ ISO 50002, Bureau of Energy Efficiency (BEE) - Energy Conservation Act, 2001, EN 16247, ANSI/MSE 2000, China's GB/T energy management standards etc.</li>
                            <li><b>Cost Reduction:</b> Identify opportunities to save energy and cut costs.</li>
                            <li><b>Sustainability Compliance:</b> Align with green energy standards and goals.</li>
                        </p>

                        <p>
                            <b>Benefits:</b>
                            <li><b>Reduced energy bills</b> </li>
                            <li><b>Improved efficiency</b> </li>
                            <li><b>Environmental impact reduction</b> </li>
                            <li><b>Enhanced corporate sustainability</b></li>
                        </p>

                        <p>
                            <b>Industries Served: </b>
                            Manufacturing, Commercial, Retail, Healthcare, and more.
                        </p>
                    </details>
                </div>
